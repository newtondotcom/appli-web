...
<template>
    <div>
        <Titre title="Informations de votre établissement" subtitle="Modifier les informations de l'établissement" />
        <div class="grid gap-4 px-4">
            ...
            <div class="grid gap-3">
                ...
                <Input id="establishmentAddress" type="text" v-model="establishmentAddress" />
            </div>
            <div class="grid gap-3">
                <Label for="establishmentSIREN">SIREN de l'établissement (optionnel)</Label>
                <Input id="establishmentSIREN" type="text" v-model="establishmentSIREN" />
            </div>
            <div class="grid gap-3">
                <Label for="establishmentDescription">Description de l'établissement</Label>
                <Textarea id="establishmentDescription" v-model="establishmentDescription" />
            </div>
            <div class="grid gap-3 mb-2">
                <Label for="establishmentImage">Image de l'établissement</Label>
                <Input id="establishmentImage" type="file" accept="image/*" @change="handleImageChange" />
                <img v-if="establishmentImage" :src="URL.createObjectURL(establishmentImage)" alt="Établissement"
