...
<template>
    <div v-if="id === -1">
    <Titre title="Création d'un évènement" subtitle="Ici, vous pouvez créer un évènement pour votre établissement" />
    </div>
    <div v-else >
    <Titre title="Modification d'un évènement" subtitle="Ici, vous pouvez modifier un évènement de votre établissement" />
    </div>
                    ...
                    <div class="grid gap-3 mx-auto w-40 my-50">
                        <Button>
                            ...
                            <div v-else class="py-2" role="status">
                                <svg aria-hidden="true" class="w-6 h-6 text-gray-200 animate-spin dark:text-gray-600 fill-primary/95" viewBox="0 0 100 101" fill="none" xmlns="http://www.w3.org/2000/svg">
