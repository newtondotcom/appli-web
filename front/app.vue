...
<div>
  ...
  <footer>
    <div class="mx-auto max-w-5xl px-4 py-16 sm:px-6 lg:px-8">
      ...
      >
        PasserellePro est une plateforme permettant de mettre des relations des éléves et des établissements (écoles / entreprises)
        pour des immersions de courte durée. 
      </p>
